...
import com.example.chatapp4.webview.Web2Activity;
...
public class Course3Activity extends AppCompatActivity {   // change here
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course3); // change here
        ...
        handout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Course3Activity.this, Web3Activity.class);
                startActivity(i);
            }
        });
    }
            ...
            AuthUI.getInstance().signOut(this)
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            Toast.makeText(Course3Activity.this, // change here
    ...
    public void goToProfile(MenuItem item) {
        startActivity(new Intent(Course3Activity.this, Profile.class)); //change this
    }
}