...
import com.example.chatapp4.webview.Web5Activity;
...
public class Course5Activity extends AppCompatActivity {   // change here
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        handout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Course5Activity.this, Web5Activity.class);
                startActivity(i);
            }
        });
    }
            ...
            AuthUI.getInstance().signOut(this)
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            Toast.makeText(Course5Activity.this, // change here
    ...
    public void goToProfile(MenuItem item) {
        startActivity(new Intent(Course5Activity.this, Profile.class)); //change this
    }
}